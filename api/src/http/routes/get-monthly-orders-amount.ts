...
export const getMonthlyOrdersAmount = new Elysia()
  .use(auth)
  .get('/metrics/monthly-orders-amount', async ({ getCurrentUser }) => {
    ...
    const currentMonthOrdersAmount = ordersPerMonth.find((monthOrderAmount) => {
